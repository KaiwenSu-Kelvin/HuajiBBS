			...
			<div class="fly-panel fly-panel-user" pad20>
				<div class="layui-tab layui-tab-brief" lay-filter="user">
					<ul class="layui-tab-title">
						...
						<li>
							<a href="http://localhost:8101/HuajiBBS/manage/post">帖子管理</a>
						</li>
					</ul>
						...
						<div class="layui-fluid">
							<div class="layui-card">
								<div class="layui-form layui-card-header layuiadmin-card-header-auto">
									<form class="layui-form" action="http://localhost:8101/HuajiBBS/manage/selectUser">
											<div class="layui-form-item">
												<div class="layui-inline">
													<label class="layui-form-label">用户名</label>
													<div class="layui-input-inline">
														<input type="text" name="name" lay-verify="required name" autocomplete="off" placeholder="通过名字查询" class="layui-input">
													</div>
												</div>
												<div class="layui-inline">
													<label class="layui-form-label">用户id</label>
													<div class="layui-input-inline">
														<input type="text" name="id" lay-verify="id" autocomplete="off" placeholder="通过ID查询" class="layui-input">
													</div>
												</div>
											</div>
													...
													<thead>
														<tr>
															...
															<th width="118px" data-field="phone" data-key="10-0-4" class="">
																<div class="layui-table-cell laytable-cell-10-0-4"><span>手机</span></div>
															</th>
															<th width="130px" data-field="email" data-key="10-0-5" class="">
																<div class="layui-table-cell laytable-cell-10-0-5"><span>邮箱</span></div>
															</th>
															<th width="80px" data-field="sex" data-key="10-0-6" class="">
																<div class="layui-table-cell laytable-cell-10-0-6"><span>性别</span></div>
															</th>
															<th width="85px" data-field="ip" data-key="10-0-7" class="">
																<div class="layui-table-cell laytable-cell-10-0-7"><span>IP</span></div>
															</th>
															<th width="30px" data-field="jointime" data-key="10-0-8" class=" layui-unselect">
																<div class="layui-table-cell laytable-cell-10-0-8"><span>加入时间</span><span class="layui-table-sort layui-inline"><i class="layui-edge layui-table-sort-asc" title="升序"></i><i class="layui-edge layui-table-sort-desc" title="降序"></i></span></div>
															</th>
													...
													<tbody>
														...
														<tr data-index="${idx.index }" class="">
															...
															<td data-field="id" data-key="10-0-1" class="">
																<div class="layui-table-cell laytable-cell-10-0-1">${user.id }</div>
															</td>
															<td data-field="username" data-key="10-0-2" data-minwidth="100" class="">
																<div class="layui-table-cell laytable-cell-10-0-2">${user.name }</div>
															</td>
															<td data-field="avatar" data-key="10-0-3" data-content=".jpg" class="">
																<div class="layui-table-cell laytable-cell-10-0-3"> <img style="display: inline-block; width: 50%; height: 100%;" src="<%=request.getContextPath()%>/image/head/${user.head }"> </div>
															</td>
															...
															<td data-field="email" data-key="10-0-5" class="">
																<div class="layui-table-cell laytable-cell-10-0-5">1@qq.com</div>
															</td>
															<td data-field="sex" data-key="10-0-6" class="">
																<div class="layui-table-cell laytable-cell-10-0-6">男</div>
															</td>
															<td data-field="ip" data-key="10-0-7" class="">
																<div class="layui-table-cell laytable-cell-10-0-7">111</div>
															</td>
															<td data-field="jointime" data-key="10-0-8" class="">
																<div class="layui-table-cell laytable-cell-10-0-8">20171204</div>
															</td>
															<td data-field="9" data-key="10-0-9" align="center" data-off="true" class="layui-table-col-special">
																...
																<c:choose>
																	<c:when test="${empty user.unBanDate }">
																	<a href="http://localhost:8101/HuajiBBS/ban/banUser?uid=${user.id }" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit"><i class="layui-icon layui-icon-edit"></i>封禁</a>
																	</c:when>
																	<c:when test="${not empty user.unBanDate }">
																	<a href="http://localhost:8101/HuajiBBS/ban/unbanUser?uid=${user.id }" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit"><i class="layui-icon layui-icon-edit"></i>解封</a>
																	</c:when>
																</c:choose>
...
<script src="<%=request.getContextPath()%>/layui/index.js"></script>
<script>
//JavaScript代码区域
